...
export default function Product() {
  ...
  const {data, error, isLoading} : {data: SupplierResponse, error: any, isLoading : boolean}= useSWR(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/supplier?page=${page}&search=${searchWord}`, fetcher)
