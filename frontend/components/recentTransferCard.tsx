...
export default function TransactionItem({ transaction }: { transaction: DashboardDataType['transaction'][0] }) {
    ...
    return (<div key={transaction.id} className="flex justify-between items-center py-3 border-b border-slate-800 last:border-0 hover:bg-slate-800 rounded-md p-2 cursor-pointer">
